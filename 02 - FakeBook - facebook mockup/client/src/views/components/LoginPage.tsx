import {Card, CardContent, Typography, CssBaseline, CardHeader} from '@mui/material';
                    ...
                    <div className='wrapper_login'>
                        <div className='wrapper_login-components'>
                            <div className='wrapper_login-description'>
                                ...
                                <Typography variant='h5'>Facebook does not help you connect and share with the people in your life.</Typography>
                            </div>
                            <div className='wrapper_loginRegister-bunch'>
                                <Card>
                                    <CardHeader sx={{m: '0 .5em', p: ' 1.5em 1em 0 1em'}} action={<LoginForm userId={userId} loggedIn={loggedIn} theme={theme} lightTheme={lightTheme} darkTheme={darkTheme} loginWarning={loginWarning} setLoginWarning={setLoginWarning} setUsersPersonalInfo={setUsersPersonalInfo} setLoggedIn={setLoggedIn} setUserId={setUserId} />}></CardHeader>
                                    <div className='login-form_buffer'>
                                        <p>‎</p>
                                    </div>
                                    <CardContent sx={{m: 0, p: 0}}>
                                        <RegisterModal theme={theme} lightTheme={lightTheme} darkTheme={darkTheme} registerWarning={registerWarning} setRegisterWarning={setRegisterWarning} />
                                    </CardContent>
                                </Card>
                                <h4>
